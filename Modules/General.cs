...
namespace EssentiBot.Modules
{
    public class General : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Mute(SocketGuildUser user, int minutes, [Remainder]string reason = null)
        {
            ...
            await _serverHelper.SendLogAsync(Context.Guild, "Command executed", $"{Context.User.Username} executed the mute command!");
        }
        ...
        public async Task Unmute(SocketGuildUser user)
        {
            ...
            await _serverHelper.SendLogAsync(Context.Guild, "Command executed", $"{Context.User.Username} executed the unmute command!");
        }
    }
}
